            ...
            <div className="about-container">
                ...
                <div className="about-content">
                    <div className="text-wrapper">
                        <div className="subtitle">What is OHSEA?</div>
                        <div className="text">
                        ...
                        <div className="subtitle">Why esports?</div>
                        <div className="text">
                        ...
                        <div className="subtitle">What does OHSEA offer?</div>
                        <div className="text">
                        ...
                        <Link to="/about" className="red-text" >
